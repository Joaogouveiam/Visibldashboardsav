...
const DEFAULTS: Record<string, string> = {
  status: 'all', sort: 'newest', channel: 'all', priority: 'all', category: 'all', client: '',
}
...
export function EscalationsFilters({ channels = [], categories = [] }: Props) {
    ...
    <div className="glass rounded-2xl px-4 py-3 space-y-3">
      ...
      <div className="flex items-center gap-3 flex-wrap pl-5">
        ...
        <div className="flex items-center gap-1.5">
          ...
          <select value={currentPriority} onChange={e => update('priority', e.target.value)} className={sel}>
        ...
        {categories.length > 0 && (
          <div className="flex items-center gap-1.5">
            ...
            <select value={currentCategory} onChange={e => update('category', e.target.value)} className={sel}>
